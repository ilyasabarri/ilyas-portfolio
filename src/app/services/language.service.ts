...
export const EN = {
  ...
  exp: {
    ...
    roles: [
      { date: '2026', title: 'Chief Operating Officer', company: 'Sinosource SARL', desc: 'As the operational lead for Sinosource\'s COD e-commerce division, engineered and managed the entire business infrastructure from the ground up. Operating at the intersection of digital marketing, technology, and supply chain logistics, successfully scaled the fulfillment network across 14 cities while leveraging AI automation and strategic media buying to drive revenue and ensure lean, high-margin operations.', tags: ['Strategy & Business Development', 'Full-Stack Web Development', 'Performance Marketing', 'Media Buying', 'Logistics & Supply Chain', 'AI Automation', 'COD E-commerce', 'Vendor Negotiation', 'Financial Reconciliation'] },
  ...
  projects: {
    ...
    items: [
      { title: 'North Creative Agency', desc: 'Full-stack creative agency website built for a Moroccan communication agency — premium web design, animations, and digital brand experience.', url: 'https://north-creative-agency.vercel.app', tags: ['Web Design', 'Next.js', 'Animation'] },
...
export const FR: typeof EN = {
  ...
  exp: {
    ...
    roles: [
      { date: '2026', title: 'Directeur des Opérations (COO)', company: 'Sinosource SARL', desc: "En tant que responsable opérationnel de la division e-commerce COD de Sinosource, j'ai conçu et géré toute l'infrastructure business from scratch. À l'intersection du marketing digital, de la technologie et de la logistique, j'ai scalé le réseau de fulfillment dans 14 villes en utilisant l'automatisation IA et le media buying stratégique pour générer du revenu avec des marges élevées.", tags: ['Stratégie & Business Development', 'Développement Web Full-Stack', 'Performance Marketing', 'Media Buying', 'Logistique & Supply Chain', 'Automatisation IA', 'E-commerce COD', 'Négociation Fournisseurs', 'Réconciliation Financière'] },
  ...
  projects: {
    ...
    items: [
      { title: 'North Creative Agency', desc: 'Site vitrine full-stack pour une agence de communication marocaine — web design premium, animations et expérience de marque digitale.', url: 'https://north-creative-agency.vercel.app', tags: ['Web Design', 'Next.js', 'Animation'] },
